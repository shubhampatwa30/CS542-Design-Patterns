...
public final class FileProcessor {
	...
	public FileProcessor(String inputFilePath)
		...
		if (!Files.exists(Paths.get(inputFilePath))) {
			throw new FileNotFoundException("invalid input file or input file in incorrect location: "+ inputFilePath);
		}
		if(this.checkForEmptyFile(inputFilePath) == false) {
	...
	public boolean checkForEmptyFile(String inputFilePath) {
		File obj =new File(inputFilePath);
		if(obj.length() != 0) {
			return true;
		}
		return false;
